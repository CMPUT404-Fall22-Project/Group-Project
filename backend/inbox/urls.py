...
from .views import InboxList, InboxDetail, filter_inbox, handle_follow_request, handle_like, handle_comment
...
urlpatterns = [
    ...
    path("handle-comment/", handle_comment, name="handle_comment")
]
